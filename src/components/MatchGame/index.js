...
class MatchGame extends Component {
  ...
  clickingThumbnail = id => {
    ...
    const imageEl = imagesList.find(eachEl => eachEl.id === id)
    if (activeImageUrl === imageEl.imageUrl) {
      this.setState(prevState => ({
  ...
  render() {
    const {score, timer, activeTabId, activeImageUrl, hasGameEnded} = this.state
      ...
      <div className="container">
            ...
            <li>
              <div className="score-container">
                ...
                <img
                  ...
                  alt="timer"
                />
                <p className="score-style">{timer} sec</p>
              </div>
            </li>
          </ul>
        </nav>
        {hasGameEnded ? (
          <div className="score-card">
            ...
            <p className="your-score-text">{score}</p>
            <button
              className="play-again-btn"
              type="button"
              onClick={this.onRestartingGame}
            >
              <img
          ...
          <div className="bottom-container">
            <img src={activeImageUrl} className="image-to-match" alt="match" />
            <ul className="tabs-list">
              {tabsList.map(eachTab => (
                <TabItem
                  tabDetails={eachTab}
                  key={eachTab.tabId}
                  makingTabActive={this.makingTabActive}
            ...
            <ul className="thumbnails-list">
              {filteredList.map(each => (
                <ThumbnailItem
                  imageDetails={each}
                  key={each.id}
                  clickingThumbnail={this.clickingThumbnail}
                />
              ))}
            </ul>
          </div>
